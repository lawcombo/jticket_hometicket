	...
	<div class="body-contents-wrap reservediv">
		...
		<section class="tabs ewp_tabs">
			<ul>
				...
				<li class="active">
					<div>
						<strong>02</strong> <span>예매정보입력</span>
					</div> <span class="material-icons">arrow_forward_ios</span>
				</li>
				<li>
					<div>
				...
				<section class="reserve reserve-form s_ftsize">
					<div class="verticalAlignMiddle insertrs">
						...
						<dl class="reserveDl full mt50">
							<button type="button" id="reserverAuthenticationButton" class="buttonTypeCyan full textLarge" style="cursor:pointer;" onmouseover="this.style.background='#2be6ed'" onmouseout="this.style.background='#05cdd5'">본인인증</button>
						...
						<dl class="reserveDl full mt20">
							...
							<dd class="reserveDd">
								<dl class="columnDl noPadding">
									...
									<dd class="columnDd">
										<button class="buttonTypeCyan full textLarge" type="button" id="couponBtn">쿠폰 추가</button>
									</dd>
								</dl>
							</dd>
						</dl>
				...
				<div class="paybx">
					...
					<section class="reserve reserve-agree agreesec line_he">
						<div class="verticalAlignMiddle ewp_insert_agree_ex">
									...
									<div class="columnDl fontSize20 agree_top ewp_insert_agree_top">
										<div class="columnDt textAlignLeft ewp_iat_left">
											<div class="agreementToggle ft20 tgicon">
												<p class="ewp_insert_agree_tit">개인정보 수집 동의 (선택)</p>
							...
							<ul class="agreementUl mt40 last_agree">
								<li class="agreementLi question toggleHeader" style="border-bottom: none;">
									<div class="columnDl fontSize20 agree_top ewp_insert_agree_top">
										<div class="columnDt textAlignLeft ft20 termsOfUseToggle ewp_iat_left">
											<div>
												<p class="ewp_insert_agree_tit">이용 규정에 대한 동의(필수)</p>
												<img src="https://dsfyc8ahox9m2.cloudfront.net/static/images/reservationRenew/img_icon_arrowDown.png" alt="key visual" class="imgAgreementArrowDown"> 
												<span class="require"></span>
											</div>
										</div>
														...
														<div id="agreementTermsOfUse-modal-section" class="md_cont">
															...
															<div class="modal_tb">
																<div class="mt_top">
																	...
																	<p class="mt_top_text">이용수칙 및 유의사항 안내 드릴게요.</p>
																</div>
																<div class="mt_bot">
																	<h3>보호자 동반 입장</h3>
																	<p class="mt_txt">
																		- 아이들의 안전을 위해 <span class="txt_red_st">보호자 없이는 이용을 제한</span>하며,<br>
																		- 키즈카페 내에 <span class="txt_red_st">아이들의 안전은 보호자가 책임</span>집니다.
																	</p>
																	<h3>양말 착용 필수 / 긴 옷 착용 권장</h3>
																	<p class="mt_txt">
																		- 위생을 위해 <span class="txt_red_st">보호자는 양말을 반드시 착용</span>하여 주시고,<br>
																		- 아이들의 안전을 위해 <span class="txt_red_st">미끄럼방지 양말 및 긴옷 착용을 권장합니다.
																	</p>
																	<h3>전염성 질병은 완치 후 입장</h3> 
																	<p class="mt_txt">
																		- <span class="txt_red_st">전염성이 있는 질병</span>(감기, 수족구, 눈병 등)을 앓고 있는 어린이는 <span class="txt_red_st">완치 후 입장</span>이 가능합니다.
																	</p>
																	<h3>
																		파손, 분실 시 배상
																	</h3>
																	<p class="mt_txt">
																		- 시설물, 교구 등을 <span class="txt_red_st">파손, 분실 할 경우</span>에는 <span class="txt_red_st">원상회복</span> 또는 <span class="txt_red_st">현 시가로 배상</span>하여야 합니다.
																	</p>
																	<h3>
																		놀이공간 반입금지
																	</h3>
																	<p class="mt_txt">
																		- 키즈카페 내의 모든 어린이 <span class="txt_red_st">놀이공간에는 음식물과 장난감 및 기타 위험 물품을 가지고 들어갈 수 없습니다.</span>
																	</p>
																</div>
															</div>
								...
								<li class="agreementLi answer termsOfUseToggleContent" style="display: none; ">
									<div class="pt20 pb20 ag_tg">
					...
					<section class="pay">
						...
						<div class="submitbox">
							<button id="settlementButton" class="buttonTypeCyan full bold py" onmouseover="this.style.background='#2be6ed'" onmouseout="this.style.background='#05cdd5'">결제하기</button>
						</div>
					</section>
...
/* 	$("#confirmCert").on('click', function(){
	...
	$("#settlementButton").on('click', function(e) {
		...
		popupCenter({url: '', title: popupTitle, w: 500, h: 550});
...
var setReturnedPayValuesFromChildWindow = function (result) {
	if(result.success == 1) {
		window.location.href= "/ticketing/ganghwakidscafe/finish?content_mst_cd=<c:out value='${essential.content_mst_cd }' />&product_group_code=<c:out value='${essential.product_group_code }' />&orderNo=" + result.orderNo;	
	}
