...
<%@ include file="../../../include/rimopass/hjcruise/header-single.jsp"%>
														...
														<div id="agreementTermsOfUse-modal-section" class="md_cont">
															...
															<div class="modal_tb">
																...
																<div class="mt_bot">
																	...
																	<p class="mt_txt">
																		- <span class="txt_red_st">전염성이 있는 질병</span>(감기, 수족구, 눈병 등)을 앓고 있는 방문객은 <span class="txt_red_st">완치 후 입장</span>이 가능합니다.
																	</p>
																	<h3>
																		파손, 분실 시 배상
																	</h3>
																	<p class="mt_txt">
																		- 시설물 등을 <span class="txt_red_st">파손, 분실 할 경우</span>에는 <span class="txt_red_st">원상회복</span> 또는 <span class="txt_red_st">현 시가로 배상</span>하여야 합니다.
																	</p>
																</div>
															</div>
...
<%@ include file="../../../include/rimopass/hjcruise/footer-single.jsp"%>
</body>
</html>
