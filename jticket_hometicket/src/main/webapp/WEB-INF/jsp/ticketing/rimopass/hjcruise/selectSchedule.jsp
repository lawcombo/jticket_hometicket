		...
		<div class="calender_box">
			<section class="calendar">
				...
				<div class="datepick_txt">
					<p>* 날짜와 시간을 선택하세요.</p>
					<!-- 
					<p>* 보호자 동반 입장은 필수입니다. <span>(보호자는 성인만 가능)</span></p>
					<p>* 보호자 및 아동은 양말을 필수로 착용해주시기 바랍니다. (입장에 제한이 있을 수 있음)</p>
					<p>* 음식물 및 간식 섭취가 불가합니다. (물, 음료 가능)</p>
...
<!-- 					</p> -->
		...
		<form:form role="form" name="paymentInfo" id="ticket_frm"  action="/ticketing/rimopass/hjcruise/insertReserver?content_mst_cd=${essential.content_mst_cd}&product_group_code=${essential.product_group_code}"  method="post">
