									...
									<div class="columnDl fontSize20 agree_top ewp_insert_agree_top">
										<div class="columnDt textAlignLeft ewp_iat_left">
											<div class="agreementToggle ft20 tgicon">
												<p class="ewp_insert_agree_tit"><c:out value="${reserveInfo.info_a_title }" escapeXml="false"/></p>
								...
								<li class="agreementLi question toggleHeader" style="border-bottom: none;">
									<div class="columnDl fontSize20 agree_top ewp_insert_agree_top">
										<div class="columnDt textAlignLeft ft20 termsOfUseToggle ewp_iat_left">
											<div>
												<p class="ewp_insert_agree_tit"><c:out value="${reserveInfo.info_b_title }" escapeXml="false"/></p>
												<img src="https://dsfyc8ahox9m2.cloudfront.net/static/images/reservationRenew/img_icon_arrowDown.png" alt="key visual" class="imgAgreementArrowDown"> 
												<span class="require"></span>
											</div>
										</div>
														...
														<div id="agreementTermsOfUse-modal-section" class="md_cont">
															...
															<div class="modal_tb">
																...
																<div class="mt_bot">
																	...
																	<p class="mt_txt">
																		- <span class="txt_red_st">전염성이 있는 질병</span>(감기, 수족구, 눈병 등)을 앓고 있는 고객은 <span class="txt_red_st">완치 후 입장</span>이 가능합니다.
																	</p>
																	<h3>
																		파손, 분실 시 배상
																	</h3>
																	<p class="mt_txt">
																		- 시설물 등을 <span class="txt_red_st">파손 할 경우</span>에는 <span class="txt_red_st">원상회복</span> 또는 <span class="txt_red_st">현 시가로 배상</span>하여야 합니다.
																	</p>
