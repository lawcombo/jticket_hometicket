...
<div id="page-wrapper" class="wrp">
	...
	<section class="sel_sec">
		...
		<div class="sel_tit aos-init aos-animate" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700" data-aos-delay="300">
			...
			<span class="bar"></span>
			<div class="desc">
				<em>'원주 소금산 그랜드밸리' 빠르게 만나는 방법!!</em>
				온라인 예매로 아름다운 소금산 그랜드밸리를 지금 만나보세요! 
			</div>
		</div>
		<div class="res_btbx">
		...
		<div class="re_banner">
			<div class="re_ban_w ewp_re_ban_w">
				...
				<p class="ban_r">
					원주 소금산 그랜드밸리 <b>쉽게 만나는 방법!</b><span class="inline_b"></span>온라인 예매로 구매하세요!
					<span class="t1"> <b>온라인 예매로 아름다운 원주 소금산 그랜드밸리</b>를 지금 만나볼 수 있습니다.</span>
				</p>
			</div>
		</div>
