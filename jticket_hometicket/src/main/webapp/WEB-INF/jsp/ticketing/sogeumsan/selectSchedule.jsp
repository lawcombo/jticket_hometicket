...
<!-- 					</p> -->
		...
		<form:form role="form" name="paymentInfo" id="ticket_frm"  action="/ticketing/ganghwakidscafe/insertReserver?content_mst_cd=${essential.content_mst_cd}&product_group_code=${essential.product_group_code}"  method="post">
