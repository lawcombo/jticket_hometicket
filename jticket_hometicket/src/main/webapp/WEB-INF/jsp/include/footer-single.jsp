    ...
    <section class="footer">
        <div class="footer-menu">
            <div class="footer-menu__gnb ">
                <a href="https://jejubeer.co.kr/about" class="gray">ABOUT US</a>
                <a href="https://jejubeer.co.kr/ourbeers" class="gray">OUR BEERS</a>
                <a href="https://jejubeer.co.kr/news" class="gray">NEWS</a>
                <a href="https://jejubeer.co.kr/contact" class="gray">CONTACT</a>
                <a href="https://jejubeer.co.kr/disclosure" class="gray">IR</a>
                <a href="https://jejubeer.co.kr/terms" class="gray">서비스 이용약관</a>
                <a href="https://jejubeer.co.kr/privacyPolicy" class="gray" style="color:#000 !important">개인정보 처리방침</a>
                <a href="https://jejubeer.co.kr/videoPolicy" class="gray">영상정보 처리방침</a>
            </div>
        ...
        <div class="footer-info">
            <p class="address">
				...
				통신판매업신고번호 제 2020-제주한림-0101 호<br>
				고객센터 02-2235-5559, <a href="mailto:jejubeer@jejubeer.co.kr">jejubeer@jejubeer.co.kr</a>
            </p><br />
            <p class="copyright">COPYRIGHT 2021@ JEJU BEER COMPANY</p>
        </div>
    </section>
</footer>
</body>
